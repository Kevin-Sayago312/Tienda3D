...
namespace Tienda3D
{
    public partial class ConsultaSocios : Form
    {
        ...
        private void ConsultaSocios_Load(object sender, EventArgs e)
        {
            ...
            DataTable dt = new DataTable();
            adaptador.Fill(dt);
            dataSocio.DataSource = dt;
        }

        private void ConsultaSocios_MouseDown(object sender, MouseEventArgs e)
        {
            ReleaseCapture();
        ...
        private void ConsultaSocios_Paint(object sender, PaintEventArgs e)
        {
        ...
        private void dataCompra_CellDoubleClick(object sender, DataGridViewCellEventArgs e)
        {
            Procesos form = Procesos.GetInstancia();
            string par1, par2;
            par1 = Convert.ToString(this.dataSocio.CurrentRow.Cells["clave"].Value);
            par2 = Convert.ToString(this.dataSocio.CurrentRow.Cells["nombre"].Value);
