...
namespace Tienda3D
{
    public partial class ConsultaCompra : Form
    {
        ...
        private void ConsultaCompra_MouseDown(object sender, MouseEventArgs e)
        {
            ReleaseCapture();
        ...
        private void ConsultaCompra_Paint(object sender, PaintEventArgs e)
        {
        ...
        private void comboBusqueda_KeyPress(object sender, KeyPressEventArgs e)
        {
            try
            {
                ...
                cmd.CommandText = "SELECT * FROM compra Where (" + comboBusqueda.Text + ") LIKE ('" + txtbusqueda.Text + "%')";
                cmd.ExecuteNonQuery();
                dt = new DataTable();
